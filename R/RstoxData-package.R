...
utils::globalVariables(c(
	 ".", "..allDuplicated", "..colAgg", "..colList", "..columns", "..digits", "..keep", "..key",
	 "..signifDigits", "..sourceColumns", "..targetAndSourceVariables", "..varToExtract", "..x",
	 "AcousticCategory", "Addition", "age", "agingstructure", "ap", "aphia", "BeamKey",
	 "bottomdepthstart", "bottomdepthstop", "catCatchWgt", "catchcount", "catchpartnumber",
	 "catchproducttype", "CatchSpeciesCategoryNumber", "CatchSpeciesCategoryWeight",
	 "CatchSpeciesCode", "CatchSubsampledNumber", "CatchSubsampleWeight", "catchweight", "cc",
	 "Constant", "Country", "cruise", "Cruise", "CruiseKey", "cw", "DateTime", "direction",
	 "DoorType", "EchoType", "EDSU", "FishID", "fishingdepthmax", "fishingdepthmin", "freq", "g",
	 "gear", "Gear", "gearcondition", "GearExp", "gearflow", "HaulNo", "HaulNumber", "HaulVal",
	 "HaulValidity", "hv", "inapplicableFormats", "individualweight", "isCrustacean",
	 "isHerringOrSprat", "isHerringOrSpratOrMackerel", "latitudeend", "latitudestart",
	 "LengthClass", "LengthCode", "lengthmeasurement", "lengthsamplecount", "lengthsampleweight",
	 ...
	 "preferredagereading", "Quarter", "readability", "ReplaceBy", "reportInMM", "res", "rowIndex",
	 "RstoxDataEnv", "s", "SaCategory", "sampleFac", "samplequality", "sampletype", "Scaling",
	 ...
	 "stationstopdate", "stationstoptime", "stationtype", "StatRec", "stomach", "StopDateTime",
	 "stoxBioticObject", "subFactor", "SubsampledNumber", "subWeight", "suffixes", "Survey",
	 "SweepLngt", "target", "Time", "tissuesample", "totalNo", "totWeight", "transceiver",
	 "trawldoorarea", "trawldoorspread", "trawldoortype", "trawldoorweight", "VariableName",
	 "verticaltrawlopening", "WeightMeasurement", "winddirection", "windspeed", "wingspread",
